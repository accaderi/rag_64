...
//// Added the top part of the code and modified the Play function in order to add stop playback functionality
//// Added code part
// Define the source variable outside of the Play function
let source;

// Function to stop the playback (accessible globally)
function stopPlayback() {
    // Check if the source is defined and stop it if so
    if (source) {
...
// Function to start the playback Modified to allow stop playback
let Play = (context, audiobuffer) => {

  let promise = new Promise((resolve) => {
      source = context.createBufferSource(); // Assign the source variable
